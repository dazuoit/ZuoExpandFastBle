package com.zuo.expandfastble.blelib.base.controller;
...
import com.zuo.expandfastble.blelib.ble_base.EventMsg;
import com.zuo.expandfastble.blelib.ble_base.MineBleEventBusTag;
import com.zuo.expandfastble.blelib.ble_base.MineBleManager;
import com.zuo.expandfastble.blelib.evnetbus_bean.BleDeviceBean;
import com.zuo.expandfastble.blelib.evnetbus_bean.BleExceptionBean;
import com.zuo.expandfastble.blelib.evnetbus_bean.BleReturnData;
import com.zuo.expandfastble.blelib.evnetbus_bean.OnConnectSuccessBean;
import com.zuo.expandfastble.blelib.evnetbus_bean.OnDisConnectedBean;
import com.zuo.expandfastble.blelib.evnetbus_bean.OnRssiSuccessBean;
import com.zuo.expandfastble.blelib.evnetbus_bean.OnWriteSuccessBean;
...
public abstract class BaseControllerTools {
	...
	public void onEventMineBleManager(EventMsg eventMsg) {
		if (eventMsg == null || eventMsg.getTag() == null || eventMsg.getData() == null) {
			return;
		}
    ...
    /**
     * 不同ble相关信息都会分发出去,需要不同子类根据判定
     * 每个子类应该都有唯一判定标识,保证不同子类只接受相关的回调
     * 一般的做法是根据设备的名称或者某些特性标识判定
     * @return
     */
	public abstract boolean checkEventTag(BleDeviceBean bleDeviceBean);
